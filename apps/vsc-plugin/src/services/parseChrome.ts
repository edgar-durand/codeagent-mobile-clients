// Ported from apps/cli/src/services/parseChrome.ts. Keep in sync with that
// file so the VS Code extension produces the same chrome_steps chunks the
// mobile client already knows how to render for codeam-cli sessions.
